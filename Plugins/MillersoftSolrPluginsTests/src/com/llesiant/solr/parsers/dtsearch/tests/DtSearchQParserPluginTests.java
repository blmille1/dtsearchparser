...
public class DtSearchQParserPluginTests extends millersoftTestCase {
	/*
	...
	public void CanParseSimpleAndCaseInsensitive() {
		DtSearchQParserPlugin plugin = new DtSearchQParserPlugin();
		String qstr = "";
		SolrParams localParams = new SolrParams() {
		...
		QParser parser = plugin.createParser("", localParams, params, req)
		Query result = plugin.parse("a AnD \"broad way\"");
		...
		assertTrue(clause2.getQuery() instanceof TermQuery);
		TermQuery tq1 = (TermQuery)clause1.getQuery();
		TermQuery tq2 = (TermQuery)clause2.getQuery();
